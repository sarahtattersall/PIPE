...
public class PNMLTransformerTest extends XMLTestCase
{
    ...
    static {
        ...
        simpleNetFileBuilder.append("simpleNet.pipe.petrinet.xml");
        ...
        noDefaultArcValueBuilder.append("noDefaultArcValue.pipe.petrinet.xml");
