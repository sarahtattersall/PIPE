 ...
 */
public class GroupTransitionHandler extends ConnectableHandler {
    //implements java.awt.event.MouseWheelListener {  //NOU-PERE


    public GroupTransitionHandler(GroupTransitionView view, Container contentpane, GroupTransitionView obj,
