...
public class MacroView extends JLayeredPane implements Observer, QueryConstants, Printable {
    ...
    public void drawMacroNode() {
        ...
        MacroNode macroNode = new MacroNode(grid.getModifiedValue(xLoc), grid.getModifiedValue(yLoc));
        ...
        String msg = QueryManager.addColouring("The node on the canvas represents the fact that " + "you are building a macro. \n\n " + "The required argument can be any operation node.");
        ...
        if (newObject != null) {
            ...
            if (l == 0) {
                if (newObject instanceof PerformanceTreeNode) {
                    ...
                    add(newObject);
                    if (newObject instanceof OperationNode && MacroManager.getMode() != QueryConstants.LOADING) {
    ...
    public void printMacroDetails() {
        ...
        if (MacroManager.getEditor().getActiveMacro() != null) {
            ...
            while (k.hasNext()) {
                ...
                if (sourceID != null) System.out.println("  with source " + sourceID);
                String targetID = arc.getTargetID();
                if (targetID != null) System.out.println("  with target " + targetID);
            }
            System.out.println("------------");
        }
    }
    ...
    class MouseHandler extends MouseInputAdapter {
        ...
        public void mousePressed(final MouseEvent e) {
            ...
            if (e.getButton() == MouseEvent.BUTTON1) {
                ...
                //TODO: This switch is far too big, refactor and tidy!!!
                switch (MacroManager.getMode()) {
                    ...
                    case STATEFUNCTION_NODE:
                        ...
                        break;
                    case ARGUMENT_NODE:
                        ptObject = new ArgumentNode(grid.getModifiedValue(startX), grid.getModifiedValue(startY));
        ...
        public void mouseMoved(final MouseEvent e) {
            if (MacroView.this.arcBeingModified != null) {
                MacroView.this.arcBeingModified.setEndPoint(grid.getModifiedValue(e.getX()), grid.getModifiedValue(e.getY()), MacroView.this.shiftDown);
            }
        }
    }
