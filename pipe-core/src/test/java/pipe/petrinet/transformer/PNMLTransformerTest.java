package pipe.petrinet.transformer;
...
public class PNMLTransformerTest extends XMLTestCase {
    ...
    public static final String ONE_TOKEN_TWO_INITIAL_MARKINGS =
            "<?xml version=\"1.0\" encoding=\"iso-8859-1\"?><pnml><net id=\"Net-One\" type=\"P/T net\"><token id=\"Default\" enabled=\"true\" red=\"0\" green=\"0\" blue=\"0\"/><place id=\"P0\"><graphics><position x=\"135.0\" y=\"120.0\"/></graphics><name><value>P0</value><graphics/></name><initialMarking><value>Default,0,Red,0</value><graphics/></initialMarking></place></net></pnml>";
    public static final String TWO_TOKENS_TWO_INITIAL_MARKINGS_ONE_NONZERO =
    ...
    static {
        StringBuilder xmlDirectoryBuilder = new StringBuilder();
        xmlDirectoryBuilder.append(SLASH)
                .append("xml")
                .append(SLASH);

        StringBuilder simpleNetFileBuilder = new StringBuilder(xmlDirectoryBuilder);
        simpleNetFileBuilder.append("simpleNet.xml");
        SIMPLE_NET_FILE = FileUtils.fileLocation(simpleNetFileBuilder.toString());

        StringBuilder noDefaultArcValueBuilder = new StringBuilder(xmlDirectoryBuilder);
        noDefaultArcValueBuilder.append("noDefaultArcValue.xml");
        NO_DEFAULT_ARC_VALUE_FILE = FileUtils.fileLocation(noDefaultArcValueBuilder.toString());
    }
    ...
    private void assertArcValue(Node arc, String expectedValue) {
        ...
        TestCase.assertEquals(expectedValue, actualInscription);
    }
    ...
    public void testDefaultArcValue() {
        ...
        TestCase.assertEquals(2, nodeList.getLength());
