...
public class Passage implements IModule, ItemListener
{
    ...
    private static final String MODULE_NAME = "Passage Time Analysis";
    ...
    private JCheckBox clearCacheBox;
    private JCheckBox autoTimeBox;
    ...
    private final ActionListener analyseButtonClick = new ActionListener()
    {
        public void actionPerformed(ActionEvent arg0)
        {
            ...
            else
            {
                ...
                analyse.setPassageParameters(sourceStateGroups, destinationStateGroups, analysisSetting, Boolean.valueOf(clearCacheBox.isSelected()));
    ...
    private AnalysisSettings getTimeSettings()
    {
        ...
        try
        {
            ...
            if(autoTimeBox.isSelected())
            {
                ...
                return new AnalysisSettings(1.0, 1.0, 1.0, method, numProcessors);
            }
            else
            {
