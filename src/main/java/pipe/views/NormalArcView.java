...
public class NormalArcView extends ArcView implements Serializable
{
    ...
    public NormalArcView(double startPositionXInput, double startPositionYInput,
	...
	public NormalArcView(NormalArcView arc) {
		...
		this.setWeight(Copier.mediumCopy(arc
                                                                       .getWeight()));
    ...
    public NormalArcView paste(double despX, double despY, boolean toAnotherView,
			PetriNetView model) {
        ...
        NormalArcView copy = new NormalArcView((double) 0, (double) 0,
                                       (double) 0, (double) 0, source, target, getWeight(), source.getId() + " to "+ 
        target.getId(), false, 
