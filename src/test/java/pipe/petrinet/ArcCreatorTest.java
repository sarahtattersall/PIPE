...
//    ArcActionCreator creator;
//    PetriNet mockNet;
//    Map<String, Place<Transition>> places = new HashMap<String, Place<Transition>>();
...
//        creator = new ArcActionCreator(inhibitorStrategy, normalForwardStrategy, normalBackwardStrategy);
